...
public class View {
    ...
    String getCardLineString(String text){
        ...
        String value = String.format("%1$"+ leftIndent + "s", text);
        String rightSide = String.format("%1$"+ rightIndent + "s", "|");
        return String.join("", "|", value, rightSide);
    }
    ...
    String getCardLineString(){
        return String.format("%1$"+ CARD_WIDTH + "s", "");
    }
}
